...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAME] = LAYOUT(
    ...
    KC_LALT, KC_Z  , KC_X  , KC_C  , KC_V  ,                       KC_N   , KC_M  ,DRGSCRL,KC_BTN3,KC_WH_D,
            KC_LBRC,KC_RBRC,                                                       _______, JONMAK,        
                             KC_E   ,KC_ESC ,                              KC_3   ,
                                     KC_SPC ,                              GJONMAK,
                    KC_LSFT,                                                       KC_1   
  ),
  ...
  [_SYMBOL] = LAYOUT(
    ...
    KC_VOLD, KC_1  , KC_2  , KC_3  ,KC_LGUI,                       KC_INS , L     , D     , U     , R     ,
            _______, KC_0  ,                                                       KC_HOME,KC_END ,        
  ...
  [_MOUSE] = LAYOUT(
    KC_MPLY,KC_WH_L,KC_WH_R, KC_F11,KC_WH_U,                       _______,KC_BTN1,KC_BTN2,KC_BTN3,TOG_DEF,
    KC_LSFT,KC_BTN1,KC_BTN2,KC_BTN3,KC_WH_D,                       KC_LGUI,KC_RSFT,DRGSCRL,SNIPING,KC_RCTL,
    G(KC_L),_______,DRGSCRL,SNIPING,G(KC_T),                       _______, G(L)  , G(D)  , G(U)  , G(R)  ,
            KC_BTN4,KC_BTN5,                                                       KC_LPRN,KC_RPRN,        
                            _______,_______,                               _______,
                                    _______,                               KC_LSFT,
                    _______,                                                       _______
  )
